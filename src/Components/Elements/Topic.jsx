...
const Topic = () => {
  ...
  const topics = [
    {
      ...
      description: "Explore various sorting techniques and their implementations",
      path: "/sort"
    },
    {
  ...
  return (
  <section id="topic" className="text-center text-light">
    <div className="container">
      <div className="row">
        {topics.map((topic, index) => (
         < div key={index} className="col-4">
          <div className="topic-card" onClick={()=>handleTopicClick(topic.path)}>
