...
const AlgorithmDetails = ({ algorithm, topic }) => {
  ...
  const getAlgorithmContent = (algorithmName) => {
    ...
    until not swapped
      ...
      "Binary Search": {
        description: "Binary Search is a searching algorithm used in a sorted array by repeatedly dividing the search interval in half. It compares the target value to the middle element of the array.",
        howItWorks: [
  ...
  return (
    <div className="space-y-8">
      ...
      <motion.div
        ...
        className="backdrop-blur-sm bg-white/20 border border-white/30 rounded-2xl p-6"
      >
      ...
      >
        <div className="backdrop-blur-sm bg-white/20 border border-white/30 rounded-2xl p-6">
          <div className="flex items-center mb-4">
            <BarChart3 className="h-5 w-5 text-gray-900 mr-2" />
            <h4 className="text-lg font-semibold text-gray-900">Time Complexity</h4>
          </div>
        ...
        <div className="backdrop-blur-sm bg-white/20 border border-white/30 rounded-2xl p-6">
          <div className="flex items-center mb-4">
            <BarChart3 className="h-5 w-5 text-gray-900 mr-2" />
            <h4 className="text-lg font-semibold text-gray-900">Space Complexity</h4>
          </div>
      ...
      >
        <div className="flex items-center mb-4">
          ...
          <h4 className="text-lg font-semibold text-gray-900">Pseudocode</h4>
        </div>
        <pre className="bg-white/30 backdrop-blur-sm p-4 rounded-xl overflow-x-auto text-sm">
          <code className="text-gray-900 font-mono">{content.pseudoCode}</code>
        </pre>
      </motion.div>
      ...
      >
        <button className="flex items-center gap-2 bg-white/30 backdrop-blur-sm border border-white/40 px-6 py-3 rounded-xl text-gray-900 font-semibold hover:bg-white/40 transition-all shadow-lg">
          <Play className="h-4 w-4" />
          View Visualization
        </button>
        <button className="flex items-center gap-2 bg-white/20 backdrop-blur-sm border border-white/30 px-6 py-3 rounded-xl text-gray-700 font-semibold hover:bg-white/30 transition-all">
